...
class Thief(pygame.sprite.Sprite):
    ...
    # //==  ** Allow the up movement of the enemy **  ==// #
    def up(self):
    ...
    # //==  ** Allow the right movement of the enemy **  ==// #
    def right(self):
    ...
    # //==  ** Allow the down movement of the enemy **  ==// #
    def down(self):
        self.acc.y = THIEF_ACC
        self.move_left = False
        self.move_right = False
    ...
    # //==  ** Allow the left movement of the enemy **  ==// #
    def left(self):
        self.acc.x = -THIEF_ACC
        self.move_left = True
        self.move_right = False
